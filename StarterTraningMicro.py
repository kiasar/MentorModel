...
PATH_TO_PRETRAINED_MODEL = "Models/Micro/SIGMOID 0.03 Lenghth_4 itter_3479 all_0.8185369318181819 same_0.66015625.bin"  # make it empty if you don't have any, empty is like: ""
...
lvl = 0  # Because it is a starter model
...
for itter in range(num_itter):
    ...
    if itter > 200 or not itter % 100:  # todo: this can be changed
        ...
        with open(f'Starter Log {portion}n_L{LENGTH}.log', "a") as f:
        ...
        if test_acc_same + test_acc_all > summation + 0.002:
            ...
            try:
                torch.save(model.state_dict(),
                           f'Models/Micro/Starter SIGMOID {portion} Lenghth_{LENGTH} itter_{itter} all_{test_acc_all} same_{test_acc_same}.bin')
            except:
